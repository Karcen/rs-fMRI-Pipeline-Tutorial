...
```bash
ls /Users/karcenzheng/Downloads/Jiacheng_Zheng的3D大脑/nifti/BOLD/
```
...
img = nib.load("/Users/karcenzheng/Downloads/Jiacheng_Zheng的3D大脑/nifti/BOLD/BOLD_xxx_xxx.nii.gz")
print(img.shape)`
...
# ─────────────────────────────────────────────────────────────────────────────
PATHS = {
    "t1":  "/Users/karcenzheng/Downloads/Jiacheng_Zheng的3D大脑/nifti/T1",  # T1模态文件夹路径（无需带文件名）
    "bold": "/Users/karcenzheng/Downloads/Jiacheng_Zheng的3D大脑/nifti/BOLD",  # BOLD模态文件夹路径（核心）
    "dti": "/Users/karcenzheng/Downloads/Jiacheng_Zheng的3D大脑/nifti/DTI",  # DTI模态文件夹路径
    "dsi": "/Users/karcenzheng/Downloads/Jiacheng_Zheng的3D大脑/nifti/DSI",  # DSI模态文件夹路径
}
...
- 路径中的 `Jiacheng_Zheng的3D大脑` 需与你实际的文件夹名称一致，避免中文拼写错误；
...
```bash
# 切换到fMRI_pipeline.py所在的目录（例如：cd ~/Downloads/Jiacheng_Zheng的3D大脑）
# 运行流水线
